...
var obstaclesParams = [
    {
        name: "ambulance",
        imgSrc: "../images/game/ambulance.png",
        width: 156,
        height: 76
    },
    {
        name: "car1",
        imgSrc: "../images/game/car1.png",
        width: 176,
        height: 76
    },
    {
        name: "car2",
        imgSrc: "../images/game/car2.png",
        width: 160,
        height: 76
    },
    {
        name: "car3",
        imgSrc: "../images/game/car3.png",
        width: 165,
        height: 76
    },
    {
        name: "police",
        imgSrc: "../images/game/police.png",
        width: 165,
        height: 76
    },
    {
        name: "taxi",
        imgSrc: "../images/game/taxi.png",
        width: 147,
        height: 76
    }
];

var obstaclesPositions = [372, 284, 194, 104];
...
function startGame() {
    myGameArea.start();
    myBus = new component(259, 80, 2, 205, "red");
}
...
function updateGameArea() {
    ...
    for (i = 0; i < myObstacles.length; i +=1) {
        if (myBus.crashWith(myObstacles[i])) {
            myGameArea.stop();
            return;
        }
    }
