...
$(document).ready(function () {
    ...
    $('#button').click(function () {
      ...
      $(window).on('keydown keypress keyup', function (event) {
       ...
       $('#game').toggle(400, function () {
         $('html,body').animate({
             scrollTop: $('#game').offset().top - 65
         }, 'slow');
       });
        startGame();
    })
...
function check(adres) {
    ...
    if (adres != "") {
        var re = new RegExp("[a-zA-Z0-9\._-]{2,}[@]{1}[a-zA-Z0-9\._-]{2,}[.]{1}[a-z][a-zA-Z0-9]{1,}");
